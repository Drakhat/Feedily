...
import 'package:feedily/models/like.dart';
import 'package:feedily/models/user.dart';
import 'package:feedily/resources/repository.dart';
import 'package:feedily/ui/chat_screen.dart';
import 'package:feedily/ui/comments_screen.dart';
import 'package:feedily/ui/likes_screen.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

import 'feedily_friend_profile_screen.dart';

class FeedilyFeedScreen extends StatefulWidget {
  @override
  _FeedilyFeedScreenState createState() => _FeedilyFeedScreenState();
}

class _FeedilyFeedScreenState extends State<FeedilyFeedScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: SizedBox(
            height: 35.0, child: Image.asset("assets/feedily_logo.png")),
        actions: <Widget>[
          Padding(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: ((context) => FeedilyFriendProfileScreen(
