...
import 'package:feedily/ui/post_detail_screen.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class FeedilyFriendProfileScreen extends StatefulWidget {
  final String name;
  FeedilyFriendProfileScreen({this.name});

  @override
  _FeedilyFriendProfileScreenState createState() =>
      _FeedilyFriendProfileScreenState();
}

class _FeedilyFriendProfileScreenState
    extends State<FeedilyFriendProfileScreen> {
