...
import 'feedily_home_screen.dart';

class FeedilyUploadPhotoScreen extends StatefulWidget {
  File imageFile;
  FeedilyUploadPhotoScreen({this.imageFile});

  @override
  _FeedilyUploadPhotoScreenState createState() =>
      _FeedilyUploadPhotoScreenState();
}

class _FeedilyUploadPhotoScreenState extends State<FeedilyUploadPhotoScreen> {
                      ...
                      _repository
                        ...
                        _repository
                          ...
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: ((context) => FeedilyHomeScreen())));
                        }).catchError((e) =>
